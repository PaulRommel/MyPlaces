...
//  MyPlaces
//
//  Created by Павел Попов on 04.12.2021.
//
...
class MapManager {
    ...
    // Проверка авторищации приложения для использования сервисов геолокации
    ...
    // Стоим маршрут от местоположения пользователя до заведения
    ...
    // Меняем отображаемую зону области карты в соответвиии с перемещение пользователя
